...
import com.example.tracenotification.Lib.CustomDialog;
import com.example.tracenotification.Lib.CustomDialogClickListner;
...
public class SettingActivity extends AppCompatActivity {
    ...
    private TextView emailTv,statusTv,sendMessageAppNotificationStatusTv;
    private EditText emailEt,secondEmailEt;
...
//    private  Button turnOnNotificationBtn,turnOffNotificationBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateEmailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String secondEmail=secondEmailEt.getText().toString();
                if(email.isEmpty()){
                    ...
                    if(!secondEmail.isEmpty()){
                        updateMap.put("secondNotificationEmail",secondEmail);
                    }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        user.setSecondNotificationEmail(secondEmail);
    ...
    private void init(){
        ...
        secondEmailEt=findViewById(R.id.setting_emailEt2);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()) {
                            ...
                            if(user.getSecondNotificationEmail()!=null && !user.getSecondNotificationEmail().isEmpty()){
                                secondEmailEt.setText(""+user.getSecondNotificationEmail());
                            }
